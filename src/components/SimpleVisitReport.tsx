...
interface SimpleVisitReportProps {
  onBack: () => void;
}

const SimpleVisitReport = ({ onBack }: SimpleVisitReportProps) => {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Visit tracking and analysis</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          <CardHeader>
            <CardTitle className="text-lg text-gray-900">Visit Report</CardTitle>
          </CardHeader>
...
export default SimpleVisitReport;
