  ...
  public: {
    Tables: {
      ...
      objectifs_ventes: {
        ...
        Relationships: [
          {
            foreignKeyName: "objectifs_ventes_vente_id_fkey"
            columns: ["vente_id"]
            isOneToOne: false
      ...
      ventes: {
        ...
        Relationships: [
          {
            foreignKeyName: "ventes_brick_id_fkey"
            columns: ["brick_id"]
            isOneToOne: false
            referencedRelation: "bricks"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ventes_delegue_id_fkey"
            columns: ["delegue_id"]
            isOneToOne: false
            referencedRelation: "delegues"
            referencedColumns: ["id"]
      ...
      visites: {
        Row: {
          date_visite: string
          id: string
          objectif_visite_id: string | null
        }
        Insert: {
          date_visite: string
          id?: string
